MODULE var_lookup
 ...
 type, public  ::  iLook_RFLX
  ...
  integer(i4b)     :: localCC           = integerMissing  ! 25. concentration from local basin (g/m3)
  integer(i4b)     :: DWcc              = integerMissing  ! 26. DW routed concentration from upstreams into reach/lake (g/m3)
 endtype iLook_RFLX
 ! HRU fluxes
